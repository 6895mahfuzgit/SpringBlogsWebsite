...
public class ObjectFactory {
    ...
    private final static QName _Rss_QNAME = new QName("", "com/blog/start/rss");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: rss
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "com/blog/start/rss")
